...
/* appearance */
static const char font[]            = "-*-lime-medium-r-normal-*-10-*-*-*-*-*-*-*";
static const char normbordercolor[] = "#18181C";
static const char normbgcolor[]     = "#18181C";
static const char normfgcolor[]     = "#FFFFFF";
static const char selbordercolor[]  = "#25252E";
static const char selbgcolor[]      = "#25252E";
...
/* layout(s) */
static float mfact      = 0.61;  /* factor of master area size [0.05..0.95] */
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_Home,   spawn,          {.v = volmtcmd } },
};
